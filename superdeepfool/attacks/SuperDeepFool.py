...
class SuperDeepFool(Attack):
    def __init__(self, model, steps=100,overshoot=0.02,search_iter = 0,number_of_samples = None,l_norm:str = 'L2'):
        ...
        self.deepfool = DeepFool(model,steps=steps,overshoot=0.02,search_iter=10)
    ...
    def forward(self,images, labels):
        ...
        while (True in correct) and (curr_steps < self.steps):
            for idx in range(batch_size):
                ...
                adv_image_Deepfool,target_label = self.deepfool(adv_image, label,return_target_labels=True)
